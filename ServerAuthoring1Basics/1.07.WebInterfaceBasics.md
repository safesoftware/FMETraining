...
It provides access to help tools for authors, users, administrators, and developers. It's also a shortcut to view any workspaces you have favorited and allows access to your user account options.
