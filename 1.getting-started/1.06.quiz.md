...
<quiz name="">
  <question>
    ...
    <explanation>Workspaces are built in FME Desktop, hosted by FME Server, and can be hosted in managed cloud instances using FME Cloud.</explanation>
  </question>
  <question>
    <p>
  ...
  <question> <!-- REDO if switch to 2018 data -->
    ...
    <answer>1,431</answer>
    <explanation>
      If you inspect C:\FMEData2019\Output\Training\Report.html by opening it in a browser, you should be able to find the table and chart for the Downtown local planning area. If you look at the table or chart, you can see there are 2,541 cases listed under ENG - Streets.
    </explanation>
  </question>
</quiz>
