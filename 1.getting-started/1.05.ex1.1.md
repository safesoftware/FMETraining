...
This area is where we write data. The objects here represent a report of the call records as a simple webpage (HTML) and an Excel file (311-requests-summary), as well as a CSV file with cleaned and edited data (311-requests).
