...
The Transformer Gallery is a tool for the location and selection of FME transformation tools. The number of transformers (below, 488) will vary depending on the version of FME and any optional custom transformers installed:
