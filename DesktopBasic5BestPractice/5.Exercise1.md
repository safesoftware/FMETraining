...
So, right-click the Find Nearest Pool bookmark and choose Select all Objects in Bookmark. Now press <kbd>Ctrl</kbd>+<kbd>I</kbd> to inspect the selected objects' caches.
