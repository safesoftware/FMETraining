...
<br>Start FME Workbench. Open the workspace template C:\FMEData2019\Workspaces\DesktopBasic\BestPractice-Ex1-Begin.fmw.

Let's run the workspace to cache the data. This workspace is a bit messy, but we will fix that in a later exercise:
