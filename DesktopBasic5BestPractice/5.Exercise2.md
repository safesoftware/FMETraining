...
Add a bookmark around all of the transformers between the PostalAddress reader and the FeatureJoiner, by selecting all the transformers and pressing <kbd>ctrl</kdb>+<kbd>B</kbd> on your keyboard. Then name the bookmark Prepare Addresses to Join:
