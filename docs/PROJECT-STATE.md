...
| **KNOW-2351** retire legacy `serve.py` launcher | — | — | In Backlog (**blocked**) | — | Delete launcher once Skilljar release flow ports (KNOW-2307/2323) + save-lesson (KNOW-2278). Docs repointed + `:8080` banner shipped (#43). |
