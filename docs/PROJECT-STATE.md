...
Then deferred (post-vacation): KNOW-2307 (v2/MCP), the rest of the KNOW-2323 UX rework, `lesson_drafts` reconciliation, mapping→DB, KNOW-2313 (report XSS), retire the legacy launcher (KNOW-2351).
