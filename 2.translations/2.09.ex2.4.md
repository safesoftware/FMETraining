...
Start FME Workbench (if necessary) and open the completed workspace from <a href="..\2.translations\2.03.ex2.1.md" target="_blank">Exercise 2.1</a>. Alternatively you can open C:\FMEData2019\Workspaces\IntroToDesktop\Ex2.4-Begin.fmw.
