...
<br><br>The Safe Software web site has a <a href="http://safe.com/integrate">table of supported formats</a> that can be filtered to show (among other things) which are supported on 64-bit:
