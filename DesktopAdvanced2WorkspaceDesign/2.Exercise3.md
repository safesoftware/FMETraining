...
<quiz name="">
  <question>
    ...
    <answer><br>The Tester can be moved, but not the DuplicateFilter</answer>
    <answer><br>The DuplicateFilter can be moved, but not the Tester</answer>
    <answer><br>Both can be moved</answer>
    <answer correct><br>Neither can be moved</answer>
