...
You can also look for transformers in the transformer gallery, which exists both as a window in Workbench and online. There are a number of ways in which transformers here can be located.
