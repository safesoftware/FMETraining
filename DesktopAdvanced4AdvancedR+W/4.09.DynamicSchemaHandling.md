...
<br><br>However, the parameters in a Writer feature type let us alter how that schema is defined. We can choose to take the structure from an entirely different dataset to the source. Or, we can individually define each component of our schema (Attributes, Feature Types, Geometry) in a variety of ways. 
