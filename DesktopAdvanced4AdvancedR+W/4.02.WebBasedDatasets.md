...
These transformers don't *read* data in the traditional FME sense. Instead they they read a selected file and either add the contents to an attribute or download the file to the local filesystem.
