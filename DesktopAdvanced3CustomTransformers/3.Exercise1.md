...
<br>**4) Run Workspace**
<br>Save the workspace and then run the workspace, to ensure the output has not changed.

This is just the start of this custom transformer, and we'll be making more changes to it as we go along.