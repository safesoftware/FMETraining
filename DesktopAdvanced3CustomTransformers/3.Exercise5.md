...
![](./Images/Img3.236.Ex5.FMEProcessTaskManager.png)
...
![](./Images/Img3.237.Ex5.InitialCT.png)
...
![](./Images/Img3.238.Ex5.CTSetParallelProcessing.png)


<br>**4) Set Process By**
<br>Return to the main canvas and inspect the parameters for the custom transformer instance. Select both _column and _row as the attributes to process by:

![](./Images/Img3.239.Ex5.CTParallelProcessingGroupBy.png)
...
<br>**5) Run Workspace**
<br>Run the workspace, again with a task manager or process monitor window open. Once the tiling is complete and the rest of the workspace is being processed, you’ll notice a number of FME worker processes (fmeobjectsworker.exe):

![](./Images/Img3.240.Ex5.CTParallelProcessingWorkers.png)
