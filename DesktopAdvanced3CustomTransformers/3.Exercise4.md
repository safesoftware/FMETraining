...
<td style="border: 1px solid darkorange">C:\FMEData2017\Workspaces\DesktopAdvanced\CustomTransformers-Ex4-Begin.fmw</td>
</tr>

<tr>
<td style="border: 1px solid darkorange; font-weight: bold">End Workspace</td>
<td style="border: 1px solid darkorange">C:\FMEData2017\Workspaces\DesktopAdvanced\CustomTransformers-Ex4-Complete.fmw<br>C:\FMEData2017\Workspaces\DesktopAdvanced\AverageLengthCalculator.fmx</td>
</tr>
...
<br>**1) Open Workspace**
<br>Open the workspace C:\FMEData2017\Workspaces\DesktopAdvanced\CustomTransformers-Ex4-Begin.fmw
...
![](./Images/Img3.224.Ex4.CTWorkspaceWithTransformers.png)
...
![](./Images/Img3.225.Ex4.CTCreateCTDialog.png)
...
![](./Images/Img3.226.Ex4.PartTidiedCT.png)
...
![](./Images/Img3.227.Ex4.CTOutputPortAttrs.png)
...
![](./Images/Img3.228.Ex4.CTExportOptions.png)
...
![](./Images/Img3.229.Ex4.CTLinkedOnCanvas.png)
...
<br>Place a new instance of the custom transformer in the workspace (it will be linked by default, which is fine). If you hover the mouse cursor over the transformer the pop-up text will show that it is version 1.

![](./Images/Img3.230.Ex4.CTLinkedVersionNum.png)
...
![](./Images/Img3.231.Ex4.AddingGeometryFilterToCT.png)

Inspect the parameters and select Line and Arc as the geometries to filter by:

![](./Images/Img3.232.Ex4.CTGeometryFilterParams.png)
...
![](./Images/Img3.233.Ex4.EditedCT.png)
...
![](./Images/Img3.234.Ex4.TransformerGalleryRefresh.png)
...
![](./Images/Img3.235.Ex4.CTUpgradeOption.png)
