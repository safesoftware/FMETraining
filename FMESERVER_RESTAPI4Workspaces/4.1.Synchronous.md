...
<td style="border: 1px solid darkorange">To run a job synchronously using the FME Server REST API</td>
</tr>
...
This exercise demonstrates the Transact call, which is used to run a job synchronously on FME Server. To find more information on the Transact call visit your FME Server REST API page and look for the transformations section or visit the [Rest API Transformations](https://docs.safe.com/fme/html/FME_REST/apidoc/v3/index.html#!/transformations) documentation.   
...
<table class="tg" style="table-layout: fixed; width: 100%">
  <tr>
    <th class="tg-ao4k">POST</th>
    <th class="tg-a080" style="word-wrap: break-word">https://localhost:8443/fmerest/v3/transformations/transact/Samples/austinDownload.fmw</th>
  </tr>
</table>
...
The final Header set up should look like the screenshot below.

![](./Images/image4.1.3.TransactPostman.png)
...
![](./Images/image4.1.4.BodyJSON.png)
...
![](./Images/image4.1.5.TransactResponsePostman.png)



<br>**5) View in FME Server**

Now that the job has been submitted, you can view it in FME Server. Go to your FME Server and log in as the admin user and click Jobs > Completed page on the left-hand sidebar.

![](./Images/image4.1.6.JobsAustinDownload.png)
...
Go to the Run Workspace page. Then, select Samples as the Repository and austinDownload.fmw as the workspace. Scroll down the page until you see the advanced section. Click on the plus sign, then find the published parameters. Here, we have all the parameters we can modify in the workspace. Look at the options, this time we will run the call with the railroad and streetcl options.

![](./Images/image4.1.8.LayersToDownload.png)
...
![](./Images/image4.1.9.newparameters.png)
...
![](./Images/image4.1.10.FeaturesWritten.png)
