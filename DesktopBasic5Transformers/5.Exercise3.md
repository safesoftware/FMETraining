...
<td style="border: 1px solid darkorange">C:\FMEData2016\Workspaces\DesktopBasic\Transformers-Ex3-Complete.fmw</td>
</tr>
...
<br>**10) Add RasterBandExpressionEvaluator**
...
To do this, add a RasterBandExpressionEvaluator transformer. Open the parameters dialog and set the parameters as follows:
