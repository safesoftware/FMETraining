...
This training material is designed specifically for use with FME 2020.1. You may not have some of the functionality described if you use an older version of FME.
