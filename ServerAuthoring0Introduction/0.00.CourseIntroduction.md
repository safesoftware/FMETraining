...
Welcome to this training course. Here is the standard legal information about this training document and the datasets used during the course.
...
Document Name: 	FME Server Authoring Training Manual 2019.0

All screenshots relate to FME Desktop and FME Server 2019.0; This manual has been tested with FME Desktop and FME Server 2019.0 Build 19246.

## What's New? ##
A list of changes to this manual and its accompanying datasets can be found on GitHub at [https://github.com/safesoftware/FMETraining/blob/Server-Authoring-2019/WhatsNew.md](https://github.com/safesoftware/FMETraining/blob/Server-Authoring-2019/WhatsNew.md). The file includes a list of general revisions compared to the previous year's materials. It is designed to help trainers become up-to-speed with new content, and for students to identify which FME functionality is new for the current release.
