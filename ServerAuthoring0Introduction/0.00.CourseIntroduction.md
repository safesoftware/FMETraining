...
Document Name: 	FME Server Authoring Training Manual 2020.1

All screenshots relate to FME Desktop and FME Server 2020.1; This manual has been tested with FME Desktop and FME Server 2020.1 Build 20596.

## What's New? ##
A list of changes to this manual and its accompanying datasets can be found on [GitHub](https://github.com/safesoftware/FMETraining/blob/Server-Authoring-2020/WhatsNew.md). The file includes a list of general revisions compared to the previous year's materials. It is designed to help trainers become up-to-speed with new content, and for students to identify which FME functionality is new for the current release..
