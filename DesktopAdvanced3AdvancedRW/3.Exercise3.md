...
<td style="border: 1px solid darkorange">C:\FMEData2019\Workspaces\DesktopAdvanced\ReadWrite-Ex3-Complete.fmw</td>
</tr>
...
<td style=""><b>Output Format:</b> Esri Shapefile</td>
</tr>
...
![](./Images/Img3.219.Ex3.InitialWorkspace.png)
...
Be sure to use the option to Rerun Entire Workspace (<kbd>Shift</kbd>+<kbd>F5</kbd>): 

![](./Images/Img3.220.Ex3.RunOptions.png) 

...otherwise cached data would be used in preference to the actual source data, which is not what we want.
...
So, when prompted click the browse button for the source Geodatabase and browse to C:\FMEData2019\Data\Addresses\Addresses.gdb
...
Click Run to rerun the workspace. Inspect the output. Notice that the output feature types are all as listed in the original data. Also, notice that the attributes are as in the original too!
...
<li>Use the Generic Reader in a dynamic workspace</li>
<li>Choose between Run Workspace and Rerun Entire Workspace</li></ul>
</span>
</td>
</tr>
</table>
