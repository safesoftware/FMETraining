...
Obviously, when a group-based transformer is needed, then it must be used. That is inevitable. However, many group-based transformers have a parameter that, in effect, turns them into feature-based.
