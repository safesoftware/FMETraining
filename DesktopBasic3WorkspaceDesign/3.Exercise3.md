...
![](./Images/Img3.403.Ex3.ViewWrittenData.png)
...
<br>Now let's re-run the workspace. But rather than re-write the output data, we can run the translation up to the new transformer we just added. Click on the HullReplacer transformer and on the icons that pop up, click Run To This:

![](./Images/Img3.404.Ex3.RunToThis.png)
...
![](./Images/Img3.408.Ex3.InspectList.png)
...
![](./Images/Img3.411.Ex3.ListHistogramResults.png)
...
![](./Images/Img3.418.Ex3.DisableFeatureCaching.png)


Now with feature caching disabled, the Run button will run the entire workspace:

![](./Images/Img3.415.Ex3.RerunEntireWorkspace.png)
