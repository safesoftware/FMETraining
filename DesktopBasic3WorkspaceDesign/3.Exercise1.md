...
Inspect the parameters for the Aggregator. Set the Group By parameter to the GroupID attribute (for example, aggregate features together in the groups created by the SpatialSorter):
