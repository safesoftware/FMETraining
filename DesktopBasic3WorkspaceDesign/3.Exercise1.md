...
<span style="color:white;font-size:x-large;font-weight: bold">Name of project</span>
</td>
</tr>
...
Yes! Here we write back to the same format of data we are reading from! You may click the Parameters buttons in the Generate Workspace dialog to check the reader/writer parameters, but none of them need changing in this exercise.
