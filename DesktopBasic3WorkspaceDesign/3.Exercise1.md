...
The output format shall be Esri Shapefile.
...
If you wish to use a predefined workspace with this information, then open the starting workspace listed above and go ahead to step 2. To plan out the different sections of workspace, continue to step 1.
...
Finally we need to group the addresses together and create a boundary shape around them:
...
So, generate a workspace to translate the following: 
...
Under the Total Count Attribute parameter, enter the name TotalResidents:
