...
![](./Images/Img3.216.Ex2.ReaderDialog.png)
...
We can do this very simply with a Cloner transformer. So add a Cloner transformer into the Calculate Residents bookmark. Connect the AttributeManager to the Cloner's input and its output to the StatisticsCalculator:
