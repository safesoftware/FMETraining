...
## What's New? ##
A list of changes to this manual and its accompanying datasets can be found on GitHub at [https://github.com/safesoftware/FMETraining/blob/Server-Admin-2019/WhatsNew.md](https://github.com/safesoftware/FMETraining/blob/Server-Admin-2019/WhatsNew.md). The file includes a list of general revisions compared to the previous year's materials. It is designed to help trainers become up-to-speed with new content, and for students to identify which FME functionality is new for the current release. 
