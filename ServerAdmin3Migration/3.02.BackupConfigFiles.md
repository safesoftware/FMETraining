...
Before proceeding with the primary task of backing up your FME Server configuration through the web interface, we recommend manually making copies the FME Server Configuration Files to a location outside of your FME Server installation directory, in case you need to refer to them later.
