...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
The Conditional Parameter definitions are constructed in the same dialog that the Tester transformer uses; therefore - like the Tester - in FME2019 various changes were made. For more information see <strong><a href="https://www.safe.com/blog/2019/03/test-clauses-2019-evangelist186/">this FME blog post</a></strong>.

<br><br>Additionally, in 2019.1 the logic of conditional parameters can be reviewed or edited using a Composite Expression field:
<br><br><img src="./Images/Img1.010b.ConditionalTestDialogDotOne.png">
</span>
</td>
</tr>
</table>
