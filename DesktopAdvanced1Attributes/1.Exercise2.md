...
<br>Data mapping means we set an attribute value (flood risk) according to the value of other atttributes. 
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
The Test Clauses dialog has been updated for FME 2019. It is used in the Tester and TestFilter transformers, plus in Conditional Values.
<br><br>For more information see <strong><a href="https://www.safe.com/blog/2019/03/test-clauses-2019-evangelist186/">this FME blog post</a></strong>.
</span>
</td>
</tr>
</table>
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
Best Practice should always play a part in any workspace. In this case there are fewer transformer, but does this make the workspace better? Is it a more aesthetic (good-looking) workspace? The decision on which method to use may depend on who will maintain the workspace.
</span>
</td>
</tr>
</table>
