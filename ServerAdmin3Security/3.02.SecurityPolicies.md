...
Connections are predefined logins to either web services or databases. Each role or user can be given permission to access different connections stored in FME Server, to create new definitions, and to manage in the FME Server web interface.
