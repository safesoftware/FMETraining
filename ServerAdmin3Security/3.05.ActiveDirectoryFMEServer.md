...
Internet browser sessions: Web browser sessions to FME Server do not expire by default. 
<br>To end a browser session with FME Server it is recommended to log out.
</span>
</td>
</tr>
</table>
