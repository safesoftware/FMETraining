...
represent an action to FME Server that you would like to complete.**
...
I often use GET and POST requests. GET requests get information already on FME Server. POST requests post new information to FME Server. For instance, I can GET a list of projects on FME Server. Then, I can use a POST request to create a new project.  
...
this course, we will discuss the different requests you can make.
...
[Configuring Authentication for Security Resources](http://docs.safe.com/fme/html/FME_Server_Documentation/Content/AdminGuide/Configuring-Authentication-for-Security-Resources.htm).
...
this course, the accept will be application/json.

3. **Content-Type:** The content type tells the server what language the
request body is in. During this course, we will use JSON,
...
provide examples later in the course.
...
![](./Images/image1.2.5.HTTPCallers.png)
