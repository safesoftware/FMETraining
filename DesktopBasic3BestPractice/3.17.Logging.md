...
Why are logging parameters the first part of debugging? Because if you don't know where the log file is - or you haven't set it up the right way <strong>before</strong> running the workspace - it will not be helpful in debugging any issues that arise!
</span>
</td>
</tr>
</table>
