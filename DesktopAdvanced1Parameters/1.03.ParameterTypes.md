...
That way FME will retain and use the actual value, here shown in the FME Data Inspector:
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
The Slider is another numeric parameter type, but it's a bit more "outside the box". Instead of manually entering a number - the user gets to pick the value from a sliding scale widget.
</span>
</td>
</tr>
</table>
...
Here the user is being asked for their name. However, the names of all users are already known – presumably this is for a particular company’s staff – so a list of them is created:
