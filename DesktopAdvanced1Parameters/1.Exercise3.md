...
<td style="border: 1px solid darkorange">C:\FMEData2017\Workspaces\DesktopAdvanced\Parameters-Ex3-Begin.fmw</td>
</tr>

<tr>
<td style="border: 1px solid darkorange; font-weight: bold">End Workspace</td>
<td style="border: 1px solid darkorange">C:\FMEData2017\Workspaces\DesktopAdvanced\Parameters-Ex3-Complete.fmw</td>
</tr>
...
<br>Start Workbench and open the workspace C:\FMEData2017\Workspaces\DesktopAdvanced\Parameters-Ex3-Begin.fmw

![](./Images/Img1.230.Ex3.InitialWorkspace.png)
...
![](./Images/Img1.231.Ex3.UsernameUserParameter.png)
...
Set the Name field to something like OutputFolder and for the Value browse to C:\FMEData2017\Output\Training

![](./Images/Img1.232.Ex3.OutputFolderParameter.png)

Set Attribute Assignement to Off, although it doesn't really matter because this will be a private parameter anyway.
...
![](./Images/Img1.233.Ex3.DestinationParameterConcatenated.png)
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
There are various ways we <strong>could</strong> have done this. We could have set the OutputFolder parameter to C:\FMEData2017\Output\Training\$(username) and then linked it to the FME Destination MapInfo parameter. You'll see in a moment why we didn't do that!
</span>
</td>
</tr>
</table>
...
![](./Images/Img1.234.Ex3.DogParkChoiceParameter.png)
...
![](./Images/Img1.235.Ex3.DogParkTesterClause.png)
...
![](./Images/Img1.236.Ex3.LabelAttributeParameter.png)
...
![](./Images/Img1.237.Ex3.LabelAttributeLabelParameter.png)
...
![](./Images/Img1.238.Ex3.CSVWriterGeneralTab.png)

In the User Attributes tab, define the attributes User and Date:

![](./Images/Img1.239.Ex3.CSVWriterAttributesTab.png)
...
![](./Images/Img1.240.Ex3.CSVWriterConnected.png)
...
![](./Images/Img1.241.Ex3.CSVWriterDestLinked.png)
...
<br><br>The point is that now the MapInfo and CSV Writers share a parameter defining their output folder. If we wish to change where they are being written to (say when the path changes from FMEData2017 to FMEData2018) we only need to edit the private parameter to fix both Writers. That's why we did what we did in step #4.
...
![](./Images/Img1.244.Ex3.TimeStamperTransformers.png)
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
If you have time for one more task, why not create a user parameter to control how the ParkArea and AverageParkArea attributes are rounded? You can choose any type of parameter you think would be best for allowing the user to select the number of decimal places to round to. It could be a Choice parameter, a Choice with Alias parameter, a Number parameter, or something else.
