...
<td style="border: 1px solid darkorange">C:\FMEData2017\Workspaces\DesktopAdvanced\Parameters-Ex2-Begin.fmw</td>
</tr>

<tr>
<td style="border: 1px solid darkorange; font-weight: bold">End Workspace</td>
<td style="border: 1px solid darkorange">C:\FMEData2017\Workspaces\DesktopAdvanced\Parameters-Ex2-Complete.fmw</td>
</tr>
...
<br>Start Workbench and open the workspace C:\FMEData2017\Workspaces\DesktopAdvanced\Parameters-Ex2-Begin.fmw

This is the workspace created by your colleagues:

![](./Images/Img1.216.Ex2.InitialWorkspace.png)
...
![](./Images/Img1.217.Ex2.InitialUserParameters.png)
...
![](./Images/Img1.218.Ex2.EncodingAnnotation.png)
...
![](./Images/Img1.219.Ex2.ShapeEncodingParameter.png)
...
So create a new user parameter (Right-click User Parameters &gt; Add Parameter), and set the Type to be **Choice with Alias**. Set the Name to be CoordSysParam, and set the prompt to be Select Output Coordinate System:

![](./Images/Img1.220.Ex2.ChoiceWithAliasParameter.png)
...
![](./Images/Img1.221.Ex2.ChoiceWithAliasImportCoordsys.png)
...
![](./Images/Img1.222.Ex2.ChoiceWithAliasImportedCoordsys.png)
...
![](./Images/Img1.223.Ex2.LinkCoordsysParameter.png)
...
![](./Images/Img1.224.Ex2.FeatureTypesToReadParameter.png)
...
![](./Images/Img1.225.Ex2.FeatureTypesToReadUserParameter.png)
...
![](./Images/Img1.226.Ex2.FeatureTypesToReadUserParameter2.png)

Underneath that change the prompt to read “Tables to Write” and then click OK to close the dialog.

![](./Images/Img1.227.Ex2.FeatureTypesToReadUserParameter3.png)
...
![](./Images/Img1.228.Ex2.QuickTranslatorStartPage.png)
...
![](./Images/Img1.229.Ex2.FinalPromptsToUser.png)
