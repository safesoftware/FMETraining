...
Click on the following attributes and press the <kbd>-</kbd> button to remove them:
...
<br>Ensure feature caching is turned on, then run the workspace by clicking on the AttributeManager transformer and selecting Run to This:
