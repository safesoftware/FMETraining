...
<br>Start Workbench (if necessary) and open the workspace from Exercise 2b. Alternatively you can open C:\FMEData2016\Workspaces\DesktopBasic\Transformation-Ex3-Begin.fmw
...
For Best Practice reasons, delete/unset any StatisticsCalculator output attributes that aren't required (for example _range and _stdev). Finally, click OK to accept the changes.
...
<br><br><li>Carry out content transformation with transformers (AreaCalculator, StatisticsCalculator)
<br><li>Manage transformer connections using pop-up buttons
