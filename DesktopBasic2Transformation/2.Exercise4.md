...
<br>Start Workbench (if necessary) and open the workspace from Exercise 3. Alternatively you can open C:\FMEData2019\Workspaces\DesktopBasic\Transformation-Ex4-Begin.fmw
...
This step can be achieved using the LabelPointReplacer transformer.


<br>**2) Create New Writer Feature Type**
<br>Because we want to write label features to a separate layer (table) in the output, we need to create another feature type object on the canvas. There is more about this in a later chapter, but for now, right-click the writer feature type and choose the option Duplicate. Doing so creates a new feature type (layer) in the output dataset.

![](./Images/Img2.229.Ex4.DuplicateFeatureType.png)
...
![](./Images/Img2.230.Ex4.StringConcatenatorCanvas.png)
...
![](./Images/Img2.231.Ex4.StringConcatenatorEmptyParams.png)
...
![](./Images/Img2.232.Ex4.StringConcatenatorParams.png)
...
![](./Images/Img2.233.Ex4.LabelPointReplacerCanvas.png)
...
![](./Images/Img2.234.Ex4.LabelEditDialog.png)
...
![](./Images/Img2.235.Ex4.LabelPointReplacerParameters.png)
...
![](./Images/Img2.236.Ex4.LabelsInDIView.png)
...
![](./Images/Img2.237.Ex4.WorkspaceWithLabelPointReplacer.png)
