...
C:\FMEData2017\Workspaces\DesktopBasic\Transformation-Ex2-Begin.fmw.
...
<br>**5) Set Parameters**
<br>View the parameters on the Tester transformer by opening the parameters dialog (the Tester has a special dialog that can't be viewed in the Parameter Editor window). Double click in the Left Value field and from there click the down arrow and choose Attribute Value > DogPark.
