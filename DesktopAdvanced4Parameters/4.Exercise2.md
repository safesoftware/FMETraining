...
The Public Safety department at the city has acquired FME and started using it for data translations.
...
![](./Images/Img4.217.Ex2.InitialWorkspace.png)
...
![](./Images/Img4.218.Ex2.InitialUserParameters.png)
...
<br>The Public Safety team want to make it easier to set the encoding of the output dataset. Currently, users are pointed by a workspace annotation towards where that writer parameter exists in the Navigator window!

![](./Images/Img4.219.Ex2.EncodingAnnotation.png)
...
![](./Images/Img4.220.Ex2.ShapeEncodingParameter.png)
...
![](./Images/Img4.221.Ex2.ChoiceWithAliasParameter.png)
...
![](./Images/Img4.222.Ex2.ChoiceWithAliasImportCoordsys.png)
...
![](./Images/Img4.223.Ex2.ChoiceWithAliasImportedCoordsys.png)
...
<br>Now we have the user's selection, but we still have to apply it to the FME parameter. Locate the writer’s coordinate system parameter, right-click on it, and choose Link to User Parameter:

![](./Images/Img4.224.Ex2.LinkCoordsysParameter.png)
...
![](./Images/Img4.225.Ex2.FeatureTypesToReadParameter.png)
...
![](./Images/Img4.226.Ex2.FeatureTypesToReadUserParameter.png)
...
![](./Images/Img4.227.Ex2.FeatureTypesToReadUserParameter2.png)

Underneath that change the prompt to read “Tables to Write” and then click OK to close the dialog.

![](./Images/Img4.228.Ex2.FeatureTypesToReadUserParameter3.png)
...
![](./Images/Img4.229.Ex2.QuickTranslatorStartPage.png)
...
![](./Images/Img4.230.Ex2.FinalPromptsToUser.png)
