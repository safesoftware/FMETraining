...
<td style="border: 1px solid darkorange">Use of FME parameters.<br>Creation and use of rser parameters</td>
</tr>

<tr>
<td style="border: 1px solid darkorange; font-weight: bold">Start Workspace</td>
<td style="border: 1px solid darkorange">C:\FMEData2019\Workspaces\DesktopAdvanced\Parameters-Ex1-Begin.fmw</td>
</tr>

<tr>
<td style="border: 1px solid darkorange; font-weight: bold">End Workspace</td>
<td style="border: 1px solid darkorange">C:\FMEData2019\Workspaces\DesktopAdvanced\Parameters-Ex1-Complete.fmw</td>
</tr>
...
<br>Start Workbench and open the workspace C:\FMEData2019\Workspaces\DesktopAdvanced\Parameters-Ex1-Begin.fmw
...
In the Navigator window locate the XML writer, expand the parameters list, and locate the parameter labeled Pretty Print. Double-click it.
...
Firstly, locate the User Parameters section of the Navigator window, right-click on it, and choose the option to Create User Parameter:
...
<br>The quickest way to create the other two required parameters (*UserMailParam* and *UserCompanyParam*) is to duplicate the *UserNameParam* parameter.
...
<br><br><img src="./Images/Img4.210.Ex1.DateTimeConverterParam.png">
<br>
...
![](./Images/Img4.211.Ex1.ParameterFetcherTransformer.png)


<br>**8) Use User Parameter – Method 3**
<br>Did you notice that the list of parameters available includes many FME-related system parameters? These are particularly useful for use with FME Server and for writing metadata, as we are here.

Locate the BuildNumber attribute on the ParksMetadata feature type. Right click on that attribute and select the Edit Value option:

![](./Images/Img4.212.Ex1.AttributeValueSetMenu.png)
...
![](./Images/Img4.213.Ex1.AttributeValueSetDialog.png)
...
![](./Images/Img4.215.Ex1.RunWithPromptDialog.png)
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
Notice that - new for FME2019 - you can choose to save your parameter values both as the default and also as a set of preset values for later recall and use.
</span>
</td>
</tr>
</table>
...
![](./Images/Img4.216.Ex1.OutputXML.png)
