...
<td style="border: 1px solid darkorange">C:\FMEData2019\Workspaces\DesktopAdvanced\Parameters-Ex3-Begin.fmw</td>
</tr>

<tr>
<td style="border: 1px solid darkorange; font-weight: bold">End Workspace</td>
<td style="border: 1px solid darkorange">C:\FMEData2019\Workspaces\DesktopAdvanced\Parameters-Ex3-Complete.fmw<br>C:\FMEData2019\Workspaces\DesktopAdvanced\Parameters-Ex3-Complete-Advanced.fmw</td>
</tr>
...
<br>Start Workbench and open the workspace C:\FMEData2019\Workspaces\DesktopAdvanced\Parameters-Ex3-Begin.fmw

![](./Images/Img4.231.Ex3.InitialWorkspace.png)
...
Notice - if you are using FME2019.1 - that there are three transformers that could be updated. For practice, why not examine what changes have been made to these transformers and decide if it is worth upgrading them? Do the changes relate to functionality or performance, and will they help in our workspace?
</span>
</td>
</tr>
</table>
...
![](./Images/Img4.232.Ex3.ParametersToDelete.png)
...
![](./Images/Img4.233.Ex3.UsernameUserParameter.png)
...
Set the Name field to something like OutputFolder, and for the Value, browse to C:\FMEData2019\Output\Training.

![](./Images/Img4.234.Ex3.OutputFolderParameter.png)
...
![](./Images/Img4.235.Ex3.DestinationParameterConcatenated.png)
...
When you run the workspace, you will be prompted to enter your name, and then the output data will now be written to C:\FMEData2019\Output\Training\&lt;Username&gt;
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
There are various ways we <strong>could</strong> have done this. We could have set the OutputFolder parameter to C:\FMEData2019\Output\Training\$(Username) and then linked it to the FME Destination MapInfo parameter. You'll see in a moment why we didn't do that!
</span>
</td>
</tr>
</table>
...
![](./Images/Img4.236.Ex3.DogParkChoiceParameter.png)
...
![](./Images/Img4.237.Ex3.DogParkTesterClause.png)

Ensure the logic column is set to OR. Now when the workspace runs, if you choose not to keep dog parks they will be filtered out from the workspace. This concept - of directing features depending on the value of a user parameter - is a very useful one to be aware of.


<br>**7) Add User Parameter**
<br>The next task is to allow the user to pick which attribute to use for a label.
...
![](./Images/Img4.238.Ex3.LabelAttributeParameter.png)
...
![](./Images/Img4.239.Ex3.LabelAttributeLabelParameter.png)
...
![](./Images/Img4.240.Ex3.CSVWriterGeneralTab.png)

In the User Attributes tab, define the attributes User and Date:

![](./Images/Img4.241.Ex3.CSVWriterAttributesTab.png)
...
![](./Images/Img4.242.Ex3.CSVWriterConnected.png)
...
![](./Images/Img4.243.Ex3.CSVWriterDestLinked.png)
...
<br><br>The point is that now the MapInfo and CSV writers share a parameter defining their output folder. If we wish to change where they are being written to (say when the path changes from FMEData2019 to FMEData2020), we only need to edit the private parameter to fix both writers. That's why we did what we did in step #4.
...
![](./Images/Img4.246.Ex3.TimeStamperTransformers.png)
