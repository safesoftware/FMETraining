...
<quiz name="">
  <question>
    ...
    <answer><li>Coordinate System Name</answer>
    <answer><li>Password</answer>
    <answer correct><li>String Encoding</answer>
    <answer><li>URL</answer>
    <explanation><br><br>A) String Encoding is not a type of FME user parameter. Technically there is an FME parameter of that type, but it's not made available as a user parameter.</explanation>
  </question>
