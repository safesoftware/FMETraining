...
A Text parameter will automatically trim any leading or trailing white space, commas, or other common delimiters. To maintain any leading or trailing white space or delimiters, use Test (Multiline).
