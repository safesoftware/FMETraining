...
![](./Images/image6.3.0.ExcelReader.png)
...
*The name of the workspace will be used in the following calls, so if you upload the workspace with a name other than Chapter6Exercise12.fmw please update it in the calls**
