...
![](./Images/Img0.000.FMEAboutScreen.png)

Look out for the [FME Lizard](https://twitter.com/FMELizard), who will appear in the manual from time-to-time, to give you advice and dispense FME-related wisdom. In fact, here he is right now...
...
<br><br>I'm no lawyer, but I suggest you be sure to read it, particularly if you're thinking about re-using or modifying this content.
</span>
</td>
</tr>
</table>
...
**Document Name:** 	FME Desktop Advanced Training Manual 2019.1

## What's New? ##
A list of changes to this manual and its accompanying datasets can be found on GitHub at [https://github.com/safesoftware/FMETraining/blob/Desktop-Advanced-2019/WhatsNew.md](https://github.com/safesoftware/FMETraining/blob/Desktop-Advanced-2019/WhatsNew.md). The file includes a list of general revisions compared to the previous year's materials. It is designed to help trainers become up-to-speed with new content, and for students to identify which FME functionality is new for the current release. 
