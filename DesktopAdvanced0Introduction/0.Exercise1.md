...
Using your FME skills you have previously learned, try and create a workspace that statisfies the requirements above. 
...
<table>
<tr><td><strong>Format:</strong></td><<td>Microsoft Excel</td></tr>
<tr><td><strong>Dataset:</td><td>PublicArt.xlsx</td></tr>
...
<table>
<tr><td><strong>Format:</strong></td><<td>File Geodatabase (File Geodb Open API)</td></tr>
<tr><td><strong>Dataset:</td><td>CommunityMapping.gdb</td></tr>
...
<br><br><img src="./Images/Img0.207.AddDWGDataset.png">
<br><br><img src="./Images/Img0.208.DWGRoadOutput.png">
</span>
</td>
</tr>
</table>
...
<table>
<tr><td><strong>Format:</strong></td><<td>Google KML</td></tr>
<tr><td><strong>Dataset:</td><td>C:\FMEData2018\Output\Walkability.kml</td></tr>
...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
The output of the Google KML isn't the prettiest, it just uses default icons. These output styles can be changed with a KMLSetter Transformer. 
</span>
</td>
</tr>
</table>
