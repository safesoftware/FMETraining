...
be sent to FMETRAINING_Engine1. You may need add a tag to multiple engines.
...
<table class="tg">
  <tr>
    ...
    <th class="tg-a080">http://&lt;yourServerHost&qt;/fmerest/v3/transformations/jobroutes/tags</th>
  </tr>
</table>
...
**Authorization:** fmetoken token= &lt;yourServerHost&qt;
...
<table class="tg">
  <tr>
    <th class="tg-ao4k">POST</th>
    <th class="tg-a080">http://&lt;yourServerHost&qt;/fmerest/v3/transformations/jobroutes/tags/High_priority/engines</th>
  </tr>
</table>
...
<table class="tg">
  <tr>
    <th class="tg-ao4k">POST</th>
    <th class="tg-a080">http://&lt;yourServerHost&qt;/fmerest/v3/transformations/jobroutes/tags/High_priority/repositories</th>
  </tr>
</table>
...
<table class="tg">
  <tr>
    <th class="tg-ao4k">POST</th>
    <th class="tg-a080">http://&lt;yourServerHost&qt;/fmerest/v3/transformations/submit/Samples/austinDownload.fmw</th>
  </tr>
</table>
...
<table class="tg">
  <tr>
    ...
    <th class="tg-ufe5">http://&lt;yourServerHost&#62;/fmerest/v3/transformations/jobs/id/&lt;yourJobID&qt;</th>
  </tr>
</table>
...
**Authorization:** fmetoken token=&lt;yourToken&qt;
