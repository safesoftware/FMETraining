...
The code block below demonstrates a sample of the JSON that is returned by the call. By using the JSON Query: json\["items"\]\[\*\], we can then use the Flattening to expose the attributes within the code we would like to use. test 
