...
Next, we attach another HTMLReportGenerator. The parameters are set up below: C:\FMEData2018\Resources\Output\Training\JobHistory.html
...
Finally, add an HTML Writer. Save the file to:
