...
We’ve outlined all of the actions you need to tak;, though FME's interface is so intuitive you should be able to carry out the exercise without the need for these step-by-step instructions.
