...
<br>**8) Filter Data**
<br>Let's filter our data to control what is displayed. We'd like to keep all of the neighborhood layer, but only show industrially-zoned zoning districts.
