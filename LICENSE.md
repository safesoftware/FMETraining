...
Unless otherwise stated, the data used here originates from open data made available by the [City of Vancouver](https://opendata.vancouver.ca "City of Vancouver, Open Data"), British Columbia. It contains information licensed under the [Open Government License - Vancouver](https://opendata.vancouver.ca/pages/licence/).
