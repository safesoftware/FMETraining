...
Look out for the FME Lizard from the City of Interopolis, who will appear from time-to-time to give you advice and dispense FME-related wisdom. In fact, here's the lizard now:
...
## What's New? ##
A list of changes to this manual and its accompanying datasets can be found [on GitHub](https://github.com/safesoftware/FMETraining/blob/Desktop-Basic-2019/WhatsNew.md). The file includes a list of general revisions compared to the previous year's materials. It is designed to help trainers become up-to-speed with new content, and for students to identify which FME functionality is new for the current release.
