...
Locate the workspace parameter called Shutdown Python Script and double-click it to open an editor window. In the window enter the following code (**NB:** *The code can be copied from the file: C:\FMEData2017\Resources\ComponentsExerciseScript.py*):
