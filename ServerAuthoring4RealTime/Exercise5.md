...
This exercise continues where exercise 0 left off. You must have completed exercise 0 to carry out this exercise.
</td>
</tr>
</table>
...
<br>**5) Test Topic**
<br>Locate the source Shape datasets in C:\FMEData2016\Data\ElevationModel\Contours - select a set of Shape files (.dbf, .prj, .shp, .shx) and create a zip file out of them (as you did in Exercise 0).
