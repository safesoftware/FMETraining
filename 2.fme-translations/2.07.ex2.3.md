...
Currently, the destination schema matches the source. However, the end user of the data has requested parts of the schema be changed.
...
Colored ports are used to visually aid schema mapping and indicate the following:
