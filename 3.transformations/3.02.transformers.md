...
Each transformer may have many parameters (settings). Parameters can be accessed (like feature types) by double-clicking the transformer name or clicking the cogwheel icon:
