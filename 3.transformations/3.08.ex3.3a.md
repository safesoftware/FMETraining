...
Your manager has some more requests for your workspace. City planners are undertaking strategic planning and want to know which local planning areas will need additional resources. They have sent you a summary table of the 3-1-1 requests and have asked you to join it to a map of the local planning areas. They also want a copy of the original data with the edited schema. In this exercise, you will look for a transformer to join the summary table to mapping data.
