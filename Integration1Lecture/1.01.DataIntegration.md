...
For instance, [CAD and GIS data can be integrated](http://blog.safe.com/2014/02/integrate-cad-gis/) to enhance a CAD drawing with specialized GIS information and attributes. The [Culpeper, Virginia, Online GIS Mapping System](http://townofculpeperva.gisbrowser.com/) is one example of a CAD-GIS data integration project.
...
[April Reeve describes it well:](https://thoughtsondata.com/2013/04/25/drivers-for-managing-data-integration-from-data-conversion-to-big-data/):
...
- merging with and leveraging external data (for example, from vendors);
...
Integrating data not only provides the benefits discussed above; it also can prevent the problem of [data silos](http://searchcloudapplications.techtarget.com/definition/data-silo/) – fixed repositories of information. Like farm silos, their contents are isolated from the outside world. Did you know the feed inside a farm silo is often [fermented](https://en.wikipedia.org/wiki/Silage#Fermentation)? Did you know the air and liquid emitted during fermentation is toxic? While silage is a valuable form of animal feed, data trapped in silos 'ferments' and becomes useless!
