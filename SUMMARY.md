...
* [Chapter 5. Using REST API calls in a workspace to automate FME Server processes](./FMESERVER_RESTAPI6JobManagement/6.0.Introduction.md)
	* [5.1 Retrieve Job History](./FMESERVER_RESTAPI6JobManagement/6.1.RetrieveJobHistory.md)
	* [5.2 Using REST API Commands in a Workbench](./FMESERVER_RESTAPI6JobManagement/6.2.UsingRest.md)
	* [5.3 Exercise 8- Creating a Workspace to Retrieve Job History](./FMESERVER_RESTAPI6JobManagement/6.3.Exercise.md)
	* [5.4 Exercise 9- Scheduling Automations with the FME Server REST API](./FMESERVER_RESTAPI6JobManagement/6.4.Exercise.md)
	* [5.5 Exercise 10- Uploading Workspaces using the FME Server REST API](./FMESERVER_RESTAPI6JobManagement/6.5.Exercise.md)
* [Chapter 7. Web Services and the REST API](./FMESERVER_RESTAPI7WebServices/7.0.WebServicesAndRESTAPI.md)
	* [7.1 Exercise 11- Sharing Workspaces in FME Server](./FMESERVER_RESTAPI7WebServices/7.1.Exercise.md)
