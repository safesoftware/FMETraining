...
* [Chapter 5. Using REST API calls in a workspace to automate FME Server processes](./FMESERVER_RESTAPI5RESTinWorkbench/5.0.Introduction.md)
	...
	* [5.3 Exercise 8- Creating a Workspace to Retrieve Job History](./FMESERVER_RESTAPI5RESTinWorkbench/5.3.Exercise.md)
	* [5.4 Exercise 9- Scheduling Automations with the FME Server REST API](./FMESERVER_RESTAPI5RESTinWorkbencht/5.4.Exercise.md)
	* [5.5 Exercise 10- Uploading Workspaces using the FME Server REST API](./FMESERVER_RESTAPI5RESTinWorkbench/5.5.Exercise.md)
