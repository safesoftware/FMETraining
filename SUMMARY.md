...
* [Performance Considerations](./DesktopAdvanced2Performance/2.00.PerformanceConsiderations.md)
    ...
    * Reader and Writer Optimization
	    * [Assessing Reader Performance](./DesktopAdvanced2Performance/2.09.AssessingReaderPerformance.md)
	    * [Improving Reader Performance](./DesktopAdvanced2Performance/2.10.ImprovingReaderPerformance.md)
	    * [Assessing Writer Performance](./DesktopAdvanced2Performance/2.11.AssessingWriterPerformance.md)
	    * [Improving Writer Performance](./DesktopAdvanced2Performance/2.12.ImprovingWriterPerformance.md)
    * [Transformer Optimization](./DesktopAdvanced2Performance/2.13.TransformationOptimization.md)
	    * [Improving Transformer Performance](./DesktopAdvanced2Performance/2.14.ImprovingTransformerPerformance.md)
	    * [More Transformer Performance Improvements](./DesktopAdvanced2Performance/2.15.ImprovingTransformerPerformance2.md)
    * Database Optimization
	    * [Optimizing Database Readers](./DesktopAdvanced2Performance/2.16.DatabaseOptimizationReading.md)
	    * [Optimizing Database Writers](./DesktopAdvanced2Performance/2.17.DatabaseOptimizationWriting.md)
    * [Parallel Processing](./DesktopAdvanced2Performance/2.18.ParallelProcessing.md)
    * [Server and Cloud Performance](./DesktopAdvanced2Performance/2.19.FMEServerFMECloud.md)
    * [Module Review](./DesktopAdvanced2Performance/2.20.ModuleReview.md)
    * [Q+A Answers](./DesktopAdvanced2Performance/2.21.QuestionAnswers.md)
