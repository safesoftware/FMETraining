...
<td style="border: 1px solid darkorange">C:\FMEData2018\Workspaces\DataIntegration\ScenarioBegin.fmw<br></td>
</tr>
...
To start off, inspect the data you have been given. There is a wide variety of topics and formats available. Following the instructions from [Exercise 3](..\Integration3Scenario\Exercise3.md), open some of these files in the FME Data Inspector to see what attributes they have.
