...
We covered creating labels in [Exercise 4](..\Integration3Scenario\Exercise7.md). Refer to that exercise if you run into problems creating labels for your map. There are a few key points to remember:
