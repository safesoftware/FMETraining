...
Use this information to **update the server and token section to your own.** If you wish to locate your token again. Go to this link:
...
Next, we can view the processForm function this is located on line number 47. This function uses the FME Server JavaScript API to get the Workspace Parameters using the repository and workspace values entered by the user. We use the function FMEServer.getWorkspaceParameters to get the workspace parameters created in the call.
