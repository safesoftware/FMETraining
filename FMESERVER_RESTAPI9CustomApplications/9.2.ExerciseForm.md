...
Go to the start menu and open up Notepad++. Then, find Language in the top toolbar, find H, then select HTML. By selecting the language it will turn on the syntax highlighting. 
