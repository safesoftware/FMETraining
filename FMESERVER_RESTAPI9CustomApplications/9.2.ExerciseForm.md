...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/c5n9g70r/7/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
Go to the start of the JavaScript section (line 39).
...
On line 58 find FMEServer.generateFormItems(); and update it to:
...
In the next section of the code we are creating a button. This button will be used to activate the next function to send the job to FME Server.
