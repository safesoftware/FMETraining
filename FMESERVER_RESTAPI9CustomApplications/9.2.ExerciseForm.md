...
The link to the FME Server JavaScript API must be included in all applications that use the FME Server JavaScript API. It's also a great resource to use if you would like to learn more about the FME Server JavaScript API because it lists all the available functions.
