...
After the first form has been activated, there needs to be another form to send the data to.
...
Next, we can view the process form function this is located on line number 47. This function uses the FME Server JavaScript API to get the Workspace Parameters. This means that the parameters will be updated dynamically as the user enters their workspace and repository.
