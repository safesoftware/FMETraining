...
<td style="border: 1px solid darkorange">
<span style="font-family:serif; font-style:italic; font-size:larger">
*The following CSS is sourced from [ArcGIS Introduction to Layers](https://developers.arcgis.com/javascript/latest/sample-code/intro-layers/index.html)*
</span>
</td>
</tr>
</table>
...
<br>**7) Give the WebApplication Folder Guest Access**
...
<br>**8) Add the following code above the CSS but within the body**
...
<br>**9) Add the following code after the ALL Future code placed here comment**
...
<br>**10) Add the following code to initialize the basemap**
...
<br>**11) Add the code to add the layers to the map**
...
<br>**12) Add the code to adjust the view of the basemap**
...
<br>**13) Add the Code to create the toggle variables**
...
<br>**14) Add the Code to toggle the visibility of layers**
