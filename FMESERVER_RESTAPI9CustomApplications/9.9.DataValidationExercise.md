...
Navigate to the myFifthApp folder that is stored in the FMEData2018 folder located on the Desktop. Then, find the myFifthAppBegin.html and rename is index.html.
