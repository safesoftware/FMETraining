...
This exercise uses completed workspaces from the project folder that was uploaded to the FME Server during Exercise 17. If you did not do this, you may upload the workspaces located in the myFifthApp folder.
</span>
</td>
</tr>
</table>
...
Navigate to the myFifthApp folder that is stored in the FMEData2018 folder located on the Desktop. Then, find the myFifthAppBegin.html and rename is index.html. Change the server and token to your own.
...
<br>**16) Add the following Google Maps API information**
