...
Add this code in the HTML above `<div id="fileList"></div>`
...
he require section needed by Google Maps will now be added to the window.onload function. Note that you will need to replace the server and token values with your own.
