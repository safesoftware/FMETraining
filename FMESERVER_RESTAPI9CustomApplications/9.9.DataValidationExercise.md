...
This exercise uses completed workspaces imported from the project folder that was uploaded to the FME Server during Exercise 19. If you did not do this, you may upload the workspaces located in the myFifthApp folder. Then, ensure the guest account has access to the repository. Additionally, please complete Exercise 16 before completing this.
</span>
</td>
</tr>
</table>
