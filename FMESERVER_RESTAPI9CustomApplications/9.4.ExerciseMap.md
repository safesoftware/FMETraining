...
<script async src="//jsfiddle.net/siennaemery/c8sxk4eo/4/embed/html,js,result/"></script>
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/nbLcgxp3/5/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
![](./Images/9.4.10.drawandreset.png)
...
Find the FMEServer.init (line 67-72). Use your FME Server hostname and token to **update the server and token section to your own.** If you are on an FME training machine the URL should be https://localhost:8443
...
**Delete ```/*``` at the start of line 90 and ```*/``` on line 114.**
...
This function is located at the end of our code (line 112).

![](./Images/9.4.13.rundatas.png)
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/gykL6vor/3/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
![](./Images/9.4.15.clippingloop.png)
...
![](./Images/9.4.18.shortenstring.png)
...
Find the showResults function (line 74-89). **Delete ```/*``` at the start of line 74 and ```*/``` on line 89.**
...
![](./Images/9.4.24.downloadlinks.png)
