...
The section of code below (lines 11-13) that was added in this application connects to the Esri CSS. The Esri CSS adds the styling components to the map. Then, the JavaScript links to a JavaScript library made by Esri.

![](./Images/9.4.2.css.png)

<br>

The next section of code (line 15) links our index file to the external JavaScript file. We need to update the src (source) parameter to the name of the file. The JavaScript file will have to be kept in the same folder as the index.html file for this to work. Our javascript file will be called, arcgismap.js so the line of code will be:
