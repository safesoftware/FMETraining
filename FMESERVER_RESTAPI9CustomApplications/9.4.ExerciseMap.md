...
<td style="border: 1px solid darkorange">C:\FMEData2018\Resources\RESTAPI\mySecondApp\Completed\index.html  </td>
</tr>

<tr>
<td style="border: 1px solid darkorange; font-weight: bold">Completed JavaScript </td>
<td style="border: 1px solid darkorange">C:\FMEData2018\Resources\RESTAPI\mySecondApp\Completed\arcgismap.js  </td>
</tr>
...
Review the first 15 lines of code of the document. The first line of code creates the variables for the map, toolbar and clipping geometry. Next on line 3, we have a function that will be activated when the window loads.
...
<br>**12) Add the GeometryReplacer**
...
<br>**13) Add the CoordinateSystemSetter**
...
![](./Images/9.4.35.AttributeExposed.png)

The Flattening Parameters should look like this:

![](./Images/9.4.36.JSONF.png)



<br>**17) Add another JSONFragmenter**
...
![](./Images/9.4.39.SystemSets.png)

Currently, the workspace should look like this:


![](./Images/9.4.40.Current.png)
...
<br>**22) Add the NoFeaturesTester**
...
<br>**23) Add the DateTimeConverter**
...
![](./Images/9.4.42.DateTimeConverter.png)
...
![](./Images/9.4.46.HTML.png)


The full workspace should look like this:

![](./Images/9.4.47.Final.png)
...
![](./Images/9.4.48.GoogleMaps.png)

<br>**28) Upload the Workspace to your Server.**

Publish the workspace to FME Server. Upload under to the RESTTraining repository and save the workspace as webapp.bc.roads.fmw. Register the workspace with the Data Download service.
...
![](./Images/9.4.49.step1and2.png)


Step 3. Download the DataDownload

![](./Images/9.4.50.step3.png)

Step 4. Review the File

![](./Images/9.4.51.step4.png)
