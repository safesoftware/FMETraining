...
Go to your web directory if you are following the steps of the manual it will be http://localhost:8000/MySecondApp/www/

Right-click, on the page and select Inspect. You should see this:
