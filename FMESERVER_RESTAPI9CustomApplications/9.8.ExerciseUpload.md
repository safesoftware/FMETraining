...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/ej2v6kmd/11/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/5uL6o0t3/14/embedded/html,js,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/n243avhb/8/embedded/html,js,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/3s9bnyat/9/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/m2g7wyj8/7/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
First, click the dropdown JavaScript + No-Library (pureJS) then under LOAD TYPE ensure that ```No wrap - bottom of <body>``` is selected.

![](./Images/9.8.1.loadtype.png)  


Click run in the top right hand corner of the page. Then, right click on the results page, click on Inspect. This will open the developer tools dialog.
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/8ge6vr7h/9/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
```
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/2fx1wrzp/10/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/wL94hydv/8/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/6n9j0skh/11/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
...
function runWorkspace()
{
    if (files != undefined || archives != undefined)
    {
        ...
        FMEServer.runWorkspaceWithData(repository, workspace, params, showResults);
    }
    else
    {
...
Finally, we use the runWorkspaceWithData function to run the workspace. The params are from the process params function found in the next function. Then, the callback function is in showResults.
...
<iframe width="100%" height="300" src="//jsfiddle.net/siennaemery/pzj58nws/10/embedded/js,html,result/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
