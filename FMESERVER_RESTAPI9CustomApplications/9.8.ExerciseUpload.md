...
<br>**15) Change the Repository and Workspace**
...
<br>**18) Delete the following section**
    ...
    <form id="exampleForm">
        ...
        <hr />
<br>**19) Change the setWorkspace function**
...
<br>**21) Add the proper headings and descriptors**
...
<br>**24) Comment out the following code:**
...
<br>**25) Paste the following code :**
...
<br>**26) Paste the following code in the setWorkspace function:**
...
<br>**27) Add the following code into the runWorkspace function**
...
<br>**29) Add the following Google Maps API information**
...
<br>**30) Add the following style components**
...
<br>**31) Delete the current HTML (but not the JavaScript) and paste in the
following:**
...
<br>**32) Add the following JavaScript Code**
...
<br>**33) Add the following JavaScript Code**
...
<br>**34) Delete the runWorkspace function. Now, then add the streamResults and downloadWorkspace functions**
...
<br>**35) Add the JavaScript function newSession to the end of your script**
